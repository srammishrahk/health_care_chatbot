...
if (isset($_POST['addtouserbtn'])) {
    ...
    if (isset($_POST['full_name']) && isset($_POST['phone_no']) && isset($_POST['email']) && isset($_POST['username']) && isset($_POST['password']) && isset($_POST['confirm_password'])){
        ...
        $foe = mysqli_real_escape_string($conn, $_POST['foe']);
        ...
        if ($password == $confirm_password) {
            $sql = "insert into user (exp,full_name,phone_no,email,username,password) values('$foe','$full_name','$phone_no','$email','$username','$password')";
...
<div class="container" id="container">
    <div class="form-container log-in-container">
        <form method="post">
            <h1>Register</h1>
            <span></span>
            <input type="text" name="foe" placeholder="Field of Expertise" required/>
